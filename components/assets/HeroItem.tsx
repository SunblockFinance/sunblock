...
export const HeroItem: FC<{ title:string, subtitle?:string, promote?:boolean}> = (data) => {
  ...
  const cardbg = '#4d9daf'
  const standard = { borderRadius:'15px',  width:'100%', backgroundColor:'rgba(77,156,175,0.3)', backdropFilter: "blur(10px)"}
  const promoted = { borderRadius:'15px', width:'100%', backgroundColor:'rgba(77,156,175,0.3)', backdropFilter: "blur(10px)", boxShadow:'0px 0px 20px #d1c4e9'}
